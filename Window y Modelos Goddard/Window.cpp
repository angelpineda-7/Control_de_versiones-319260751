...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_K)
	{
		if (theWindow->articulacion5 < 45.0 && theWindow->a5 == 0)
		{
		...
		else if (theWindow->articulacion5 > -45.0 && theWindow->a5 == 1)
		{
			theWindow->articulacion5 -= 5.0;
		}
		else
	...
	if (key == GLFW_KEY_L)
	{
		if (theWindow->articulacion6 < 0.0 && theWindow->a6 == 0)
		{
			theWindow->articulacion6 += 5.0;
		}
		else if (theWindow->articulacion6 == 0.0)
		{
			theWindow->a6 = 1;
			theWindow->articulacion6 -= 5.0;
		}
		else if (theWindow->articulacion6 > -45.0 && theWindow->a6 == 1)
		{
			theWindow->articulacion6 -= 5.0;
		}
		else
