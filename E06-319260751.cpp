...
int main()
{
	...
	dadoAnimales = Texture("Textures/dadoAnimales.jpg");
	dadoAnimales.LoadTexture();
	...
	DadoAnimales = Model();
	DadoAnimales.LoadModel("Models/DadoAnimales.obj");
